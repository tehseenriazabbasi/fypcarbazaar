...
import {getnewUsers} from "./apiReport";
    ...
    renderusers= (users) => (
        ...
        <div className={"card"} style={{
            ...
            <div className={"card-body"}>
                <h6 className="card-title">New Members</h6>
                ...
                <table className={"table table-inverse"}>
                    ...
                    {users.map((user,i)=>(
                        <tr scope="row"  key={i}>
                            ...
                            <td > {user.created}</td>
                            <td>
                                <Link to={`/profile_details/${user._id}`} className="btn  btn-raised btn-primary btn-sm">Details</Link>
                            </td>
                        </tr>
                    ))}
                    </tbody>
