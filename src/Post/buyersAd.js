...
import {createBuyer, getMake, getModel} from "./apiPost";
...
class buyersAd extends Component {
    constructor(){
        super();
        this.state = {
            city: "",
    ...
    clickSubmit = event => {
        ...
        if(this.isvalid()) {
            ...
            createBuyer(userId, token, this.postData)
                .then(data => {
                    if (data.error) {
                        console.log(data.error);
                        ...
                        <div className={"row"}>
                            ...
                            <div className={"col-md-6 mt-2"}>
                                ...
                                <form className={classes.form}>
                                    ...
                                    <button style={{width:'100%', 'margin-top': '4px' }} className="btn btn-raised btn-danger" onClick={this.clickSubmit}>
                                        Post Ad
                                    </button>
                                </form>
                            </div>
...
export default withStyles(styles)(buyersAd);
