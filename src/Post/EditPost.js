        ...
        return (
            <Container component="main" maxWidth="md">
                ...
                <form className={classes.form}>
                    ...
                    <InputLabel id="Registration_city">Regitration City</InputLabel>
                    <Select
                    ...
                    <InputLabel id="color">Exterior Color</InputLabel>
                    <Select
                        labelId="color"
                        id="exterior_color"
                ...
                <div className={"row"}>
                    ...
                    <div className={"col-md-6 mt-2"}>
                        ...
                        <form className={classes.form}>
                            ...
                            {/*<InputLabel className={"mt-2"} id="color">Select Photos</InputLabel>
